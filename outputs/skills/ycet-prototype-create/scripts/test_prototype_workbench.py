...
class ServiceTests(unittest.TestCase):
    ...
    def test_served_assets_include_undo_button(self) -> None:
        ...
        self.assertIn(b"applyFieldChange", script)
        self.assertIn(b"fieldSession", script)
        self.assertIn(b'type: "text", fingerprint', script)
        self.assertIn(b"refreshPreviewAfterAgentResult", script)
        self.assertIn(b"showResults(state.results)", script)
        self.assertIn(b"ensureBorderVisible", script)
